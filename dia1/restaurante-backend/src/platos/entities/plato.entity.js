...
var Plato = function () {
    var _classDecorators = [(0, typeorm_1.Entity)('platos')];
    ...
    var Plato = _classThis = /** @class */ (function () {
        function Plato_1() {
            ...
            this.createdAt = (__runInitializers(this, _disponible_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
    ...
    (function () {
        ...
        _disponible_decorators = [(0, typeorm_1.Column)({ default: true })];
